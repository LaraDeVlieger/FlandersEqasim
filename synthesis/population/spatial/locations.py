...
def execute(context):
    ...
    df_secondary_locations = gpd.GeoDataFrame(df_secondary_locations)
    df_secondary_locations = df_secondary_locations.to_crs("EPSG:3812")
    ...
    df_locations = gpd.GeoDataFrame(df_locations, crs = "EPSG:3812")
